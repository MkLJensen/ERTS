...
reg   [0:0] tmp_1_reg_165;
(* fsm_encoding = "none" *) reg   [3:0] ap_CS_fsm;
wire    ap_CS_fsm_state3;
reg   [27:0] t_V_fu_92;
wire    ap_CS_fsm_state2;
wire   [27:0] ADVIOS_count_V_assig_fu_133_p2;
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state3) & (tmp_1_fu_140_p2 == 1'd0))) begin
        t_V_fu_92 <= ADVIOS_count_V_assig_fu_133_p2;
    end else if (((1'b1 == ap_CS_fsm_state2) | ((1'b1 == ap_CS_fsm_state3) & (tmp_1_fu_140_p2 == 1'd1)))) begin
        t_V_fu_92 <= 28'd0;
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state4) & (tmp_1_reg_165 == 1'd1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state3) | ((1'b1 == ap_CS_fsm_state4) & (tmp_1_reg_165 == 1'd1)))) begin
...
assign ADVIOS_count_V_assig_fu_133_p2 = (t_V_fu_92 + 28'd1);

assign ADVIOS_sec_counter_V_o = (ADVIOS_sec_counter_V_i + 4'd1);
...
assign sec_pulse = 1'd1;

assign tmp_1_fu_140_p2 = ((t_V_fu_92 > 28'd99999999) ? 1'b1 : 1'b0);
